<template>
  <div class="allgoods">
    ...
    <v-skip :index="index"></v-skip>
  	...
  	<img class="allgoodspic1" src="http://mcdn.pinduoduo.com/home/static/images/sale_v2.png"/>
  	
  	<div class="allgoodsdata1">9.9特卖</div>
  	<div class="allgoodsdata2">全场9.9元起，汇聚全网优质折扣商品，限时限量特卖，好货不断。</div>
	<div class="good">
