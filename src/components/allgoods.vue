<template>
  <div class="allgoods">
    ...
    <v-skip :index="index"></v-skip>
  	...
  	<img class="allgoodspic1" src="http://mcdn.pinduoduo.com/home/static/images/seckill.jpg"/>
  	
  	<div class="allgoodsdata1">限时秒杀</div>
  	<div class="allgoodsdata2">每日精选好货超低价秒杀，限时限量，全场包邮。</div>
	<div class="good">
